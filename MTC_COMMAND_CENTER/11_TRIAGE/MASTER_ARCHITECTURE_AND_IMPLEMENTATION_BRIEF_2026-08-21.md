...
**Two distinct 2026-08-24 workstreams have dated amendments in this document, and they are not the same thing.** **(a) The final red-team fold (map #123)** applied the owner-resolved coherence and reuse-first findings. **(b) The bounded G1 audit cycle**, run as **three audit rounds with repair passes before rounds 2 and 3** against reproduced required findings of a **fresh `T0` G1 audit** of the amended set. Each amendment is marked at its own site with its date and its round, and the sites are, in document order: **§0.1** (the Q6 index), **§0.6 / §0.6.1** (round records extended append-only), **§2 F-9a and F-16**, **§4.1**, **§6.3 and §6.5**, **§10.2 / §10.2a**, **§12.5 / §12.5a / §12.6 / §12.7**, **§14.3**, **§16 M9b**, **§17.1 / §17.2**, **§18**, **§20**, **§21.1**, **§22**, and **Appendices A, C and E.7**.
