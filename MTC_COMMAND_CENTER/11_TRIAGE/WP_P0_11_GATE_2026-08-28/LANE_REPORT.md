...
| C11 | A `5c560306...`; `exits.py:395-421` | `C11-GF8-MUT-001`, rc 1: long gap stop fills at stop `95` instead of open `90` | rc 0: 4/4 leaves exact; stop hits, fills at open `90`, and closes the position |
| C12 | A `5c560306...`; `exits.py:450-491` | `C12-GF8-MUT-001`, rc 1: long gap target fills at target `105` instead of open `110` | rc 0: 4/4 leaves exact; target hits, fills at open `110`, and closes the position |
