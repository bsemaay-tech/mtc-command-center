...
## 4. Sixteen audit-derived safeguards — twelve I have acknowledged, four I have not yet seen
...
**Four more were added later the same day, and I have not seen them.** A further review found seventeen problems in the document set, and closing four of them needed safeguards that no existing requirement covered. They are **D-13, D-14, D-15 and D-16**, printed at the end of the table below and clearly marked. **I have not acknowledged them.** They are enforceable as engineering constraints in the same way as the others, but the act of showing them to me and getting my word on them **has not happened yet** — and nobody may record it as though it had.
