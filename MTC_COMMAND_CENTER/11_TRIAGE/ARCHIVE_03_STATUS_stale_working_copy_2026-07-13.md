...
- Pinned deployment: `C:\P2RT`, runtime code commit `59c334c0`, Task Scheduler `MTC-Bridge-P2`.
...
Full evidence is committed on `feature/ibkr-bridge-final` at `59352bb3`:
`docs/19_P2_RECONNECT_INCIDENT_2026-07-13.md`.
