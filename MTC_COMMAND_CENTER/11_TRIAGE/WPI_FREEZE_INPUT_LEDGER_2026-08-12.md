...
What `run_p0.sh` currently does instead: it defines, exports, and logs marker strings, then sources RP6 at `run_p0.sh:245`. With current bytes, RP6 cannot produce an end-to-end P0 PASS because `STATUS_RP6_P0.md:311-312` records 17 remaining `<PIN-AT-FREEZE>` literals and says no end-to-end `P0 PASS` is possible with them present. The earlier RP6 audit acceptance was a source/audit acceptance, not a host end-to-end P0 PASS, as shown by `RP6_CODEX_T0_AUDIT_R16_2026-08-12.md:1` and `RP6_CODEX_T0_AUDIT_R16_2026-08-12.md:23-26`.
