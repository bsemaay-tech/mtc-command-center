...
- `composite_pathproof.py` — the production module — 129658 B, SHA-256
  ...
  rounds 9–10 were evidence-harness-only. Re-derive and confirm this identity first.
- Self-QA / evidence: `SELF_QA_SEC102_R10.md` (the current round), `STATUS_SEC102.md`,
  `SEC102_R10_REPORT_2026-08-12.md`. Prior context: the Codex audit chain
  `SEC102_CODEX_T1_AUDIT_R7..R10_2026-08-12.md`.
...
## Audit contract
1. Re-run the published harness verbatim if you can execute it (`SELF_QA_SEC102_R10.md`
   §"reproduce" / §13): the 58-case matrix, the §13b D026 (rebind RED/GREEN both directions),
   the §13c/§13d eleven-block object-pinned run. GLM gates execution — if you cannot run it,
