# DESIGN NOTES - B3-GAP-ENV Option 1 design repair, round 3 (FINAL)

Round 2 received REQUEST_CHANGES. This round applies the binding findings of
`audit2/AUDIT2_REPORT.md` (A2-F1 through A2-F8) and its "Final complete repair
list for round 3", items 1-8, and weakens nothing that audit 2 verified CLOSED.

| File | Role |
|---|---|
| `round3/RP1-B3.sh` | repaired unprivileged block, full file (637 lines) |
| `round3/RPD-VERIFY.sh` | root-side deploy-time verify block, full file (750 lines) |
| `round3/DESIGN_NOTES.md` | this file |
| `round3/SELF_QA.md` | syntax evidence, three exact counts, D026 RED/GREEN closure evidence, no-content audit |

sha256 as delivered (round 3):
...
Nothing outside `round3/` was created, modified or deleted. No remote host was
...
A genuine read(2) error mid-file surfaces to a shell caller as a nonzero read with
a possibly-populated buffer, which is the same arm. Driven RED and GREEN, for
both blocks, in SELF_QA section 5.5.
...
- Section 3: both blocks are new artifacts needing new expected hashes; the
  ...
  `e561e8b4cf5444bebf2293046a3ea649712d3b229bd380e1c69364ab552397dd` if this round
  is accepted, and `RPD-VERIFY` by
  `f4c5d61de7e55bd7f2fc9f6a73754a093cb114b1c8316b85a683a78f833e63a2`.
