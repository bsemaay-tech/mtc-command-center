"""Auto-generated prototype skeleton — QL_CONNELL_EVENT_DRIVEN_GAP_5M
...
CANDIDATE_ID = "QL_CONNELL_EVENT_DRIVEN_GAP_5M"
DIRECTION = "long_only"
...
def signal_long_entry(df: pd.DataFrame, params: dict) -> pd.Series:
    ...
    Pseudocode from triage:
      is_first_5m_of_gap_day AND gap_pct>=thresh
    """
