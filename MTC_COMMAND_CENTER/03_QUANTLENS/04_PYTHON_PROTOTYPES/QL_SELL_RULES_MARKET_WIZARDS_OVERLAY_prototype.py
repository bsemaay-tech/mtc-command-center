"""Auto-generated prototype skeleton — QL_SELL_RULES_MARKET_WIZARDS_OVERLAY

Source: https://www.youtube.com/watch?v=UD7gipBWnuY
Source candidate: QLR_UD7gipBWnuY
...
CANDIDATE_ID = "QL_SELL_RULES_MARKET_WIZARDS_OVERLAY"
DIRECTION = "long_only"
...
def signal_long_exit(df: pd.DataFrame, params: dict, entry_index: int) -> bool:
    ...
    Pseudocode from triage:
      trim_on=close<SMA50; full_exit_on=ext>8% OR close<EMA_weekly20
    """
