"""Auto-generated prototype skeleton — QL_EPISODIC_PIVOT_CHRISTIAN_5M
...
CANDIDATE_ID = "QL_EPISODIC_PIVOT_CHRISTIAN_5M"
DIRECTION = "long_only"
...
def signal_long_entry(df: pd.DataFrame, params: dict) -> pd.Series:
    ...
    Pseudocode from triage:
      catalyst_proxy AND close>or_high_5m
    """
...
def signal_long_exit(df: pd.DataFrame, params: dict, entry_index: int) -> bool:
    ...
    Pseudocode from triage:
      close<low_of_day OR session_end
    """
