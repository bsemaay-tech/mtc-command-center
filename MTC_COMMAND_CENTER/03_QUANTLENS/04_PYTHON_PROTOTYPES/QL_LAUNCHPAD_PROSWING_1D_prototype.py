"""Auto-generated prototype skeleton — QL_LAUNCHPAD_PROSWING_1D
...
CANDIDATE_ID = "QL_LAUNCHPAD_PROSWING_1D"
DIRECTION = "long_only"
...
def signal_long_entry(df: pd.DataFrame, params: dict) -> pd.Series:
    ...
    Pseudocode from triage:
      prior_up_move AND atr_compressed AND breakout_volume
    """
...
def signal_long_exit(df: pd.DataFrame, params: dict, entry_index: int) -> bool:
    ...
    Pseudocode from triage:
      close<contraction_low OR trail_under_swing
    """
