"""Auto-generated prototype skeleton — QL_AVWAP_BRIAN_INTRADAY_OR_5M
...
CANDIDATE_ID = "QL_AVWAP_BRIAN_INTRADAY_OR_5M"
DIRECTION = "long_only"
...
def signal_long_entry(df: pd.DataFrame, params: dict) -> pd.Series:
    ...
    Pseudocode from triage:
      or_break AND pullback_to_avwap_held
    """
...
def signal_long_exit(df: pd.DataFrame, params: dict, entry_index: int) -> bool:
    ...
    Pseudocode from triage:
      close<avwap_intraday OR end_of_session
    """
