"""Auto-generated prototype skeleton — QL_AVWAP_BRIAN_STAGE2_EMERGING_1D
...
CANDIDATE_ID = "QL_AVWAP_BRIAN_STAGE2_EMERGING_1D"
DIRECTION = "long_only"
...
def signal_long_entry(df: pd.DataFrame, params: dict) -> pd.Series:
    ...
    Pseudocode from triage:
      stage2_ok AND higher_low_at_avwap AND turn_up
    """
...
def signal_long_exit(df: pd.DataFrame, params: dict, entry_index: int) -> bool:
    ...
    Pseudocode from triage:
      close<avwap OR trail_under_swing_low
    """
