"""Auto-generated prototype skeleton — QL_VCP_MINERVINI_1D

Source: https://www.youtube.com/watch?v=M_tD6X0CSOI
Source candidate: QLR_M_tD6X0CSOI
...
CANDIDATE_ID = "QL_VCP_MINERVINI_1D"
DIRECTION = "long_only"
...
def signal_long_entry(df: pd.DataFrame, params: dict) -> pd.Series:
    ...
    Pseudocode from triage:
      stage2_ok AND rs_new_high AND vcp_pivot_breakout
    """
...
def signal_long_exit(df: pd.DataFrame, params: dict, entry_index: int) -> bool:
    ...
    Pseudocode from triage:
      close<EMA21 OR stop OR target_3x_ATR
    """
