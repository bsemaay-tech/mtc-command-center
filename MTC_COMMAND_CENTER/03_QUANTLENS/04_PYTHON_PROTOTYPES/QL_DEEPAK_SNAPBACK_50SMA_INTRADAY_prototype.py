"""Auto-generated prototype skeleton — QL_DEEPAK_SNAPBACK_50SMA_INTRADAY

Source: https://www.youtube.com/watch?v=q43pkYBo1hU
Source candidate: QLR_q43pkYBo1hU
...
CANDIDATE_ID = "QL_DEEPAK_SNAPBACK_50SMA_INTRADAY"
DIRECTION = "long_only"
...
def signal_long_entry(df: pd.DataFrame, params: dict) -> pd.Series:
    ...
    Pseudocode from triage:
      price<channel_low AND turn_up_signal
    """
