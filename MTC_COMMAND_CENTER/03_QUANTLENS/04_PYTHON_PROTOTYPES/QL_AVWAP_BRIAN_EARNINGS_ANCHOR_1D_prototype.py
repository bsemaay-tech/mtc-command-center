"""Auto-generated prototype skeleton — QL_AVWAP_BRIAN_EARNINGS_ANCHOR_1D
...
CANDIDATE_ID = "QL_AVWAP_BRIAN_EARNINGS_ANCHOR_1D"
DIRECTION = "long_only"
...
def signal_long_entry(df: pd.DataFrame, params: dict) -> pd.Series:
    ...
    Pseudocode from triage:
      anchor_bar=top_vol_90d; pullback_to_anchor_avwap_held
    """
