"""Auto-generated prototype skeleton — QL_HIGHEST_VOLUME_EDGE_PROSWING_1D
...
CANDIDATE_ID = "QL_HIGHEST_VOLUME_EDGE_PROSWING_1D"
DIRECTION = "long_only"
...
def signal_long_entry(df: pd.DataFrame, params: dict) -> pd.Series:
    ...
    Pseudocode from triage:
      vol==max(vol, lookback) AND price_action_ok
    """
