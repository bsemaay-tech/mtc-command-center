"""Auto-generated prototype skeleton — QL_CONNELL_EVENT_DRIVEN_GAP_1D

Source: https://www.youtube.com/watch?v=kao-hhaQnig
Source candidate: QLR_kao-hhaQnig
...
CANDIDATE_ID = "QL_CONNELL_EVENT_DRIVEN_GAP_1D"
DIRECTION = "long_only"
...
def signal_long_entry(df: pd.DataFrame, params: dict) -> pd.Series:
    ...
    Pseudocode from triage:
      gap_pct>=gap_thresh AND vol_rank>=0.9
    """
...
def signal_long_exit(df: pd.DataFrame, params: dict, entry_index: int) -> bool:
    ...
    Pseudocode from triage:
      scale_out_at_VAH OR stop OR session_close_if_negative
    """
