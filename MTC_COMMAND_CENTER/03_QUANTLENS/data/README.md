...
| `native_us_equities_10m_alpaca_2026-06-28/` | SPY, QQQ, AAPL, MSFT, NVDA, AMZN, TSLA | 10m | ~57,700 each | Alpaca IEX | PASS | Earlier US-equities-only 10m bundle; superseded by the multi-asset bundle above (same data, narrower). Kept for provenance. `tools/alpaca_download_us_equities_10m.py`. CSVs git-ignored. |
