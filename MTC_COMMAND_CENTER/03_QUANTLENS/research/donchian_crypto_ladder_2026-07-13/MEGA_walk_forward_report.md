...
- Generated: `2026-07-12T21:43:40.922473+00:00`
- Runtime: `5.0s` (0.1 min) with `4` worker processes
- Symbols: 17 | Timeframes: ['15m', '1h', '2h', '4h', '1D']
- Strategies: 20 (11 prototyped + 6 generic patterns)
- Param sets total across grids: **60**
- Total (strategy, symbol, tf) jobs: **4**
- Cost: `8.0 bps` round-trip | Lockbox: last 25% | Rolling folds: 3
- Classification counts: `{'FAIL': 3, 'INSUFFICIENT_TRADES': 1}`
- PASS configurations: **0**
- Bootstrap-FDR family size (testable lockboxes): **3** | BH q=0.10 | threshold p≤0.00000
