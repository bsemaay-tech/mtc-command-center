...
- Source transcript path: `UNKNOWN_NOT_FOUND`
- Source intake path: `06_QUANTLENS_LAB\00_INBOX_REPORTS\3 Mayıs\2026-05-03_9ZJK8175drM_quantlens_canslim_detailed_intake.md`
- URL: `https://www.youtube.com/watch?v=9ZJK8175drM`
- Video ID: `9ZJK8175drM`
- Title: `2026-05-03_9ZJK8175drM_quantlens_canslim_detailed_intake`

## Transcript-Based Correction Summary
No matching transcript found in transcript directory for this intake video_id/title.

## Corrected Classification
- Classification: `DATA_BLOCKED`
- Next action: `DO_NOT_TEST_UNTIL_SOURCE_FIXED`
...
## Routing Decision
- Test/keep/reject decision: `DO_NOT_TEST_UNTIL_SOURCE_FIXED`

## What Was Wrong Or Missing In Original Intake
- Faithfulness class: `WRONG_SOURCE_MATCH`
- Missing fields: `source transcript`
