...
|---|---|---|
|AVWAP anchor|IMPLEMENTED_DIFFERENTLY|Previous code used rolling volume-weighted average as AVWAP proxy, not event-anchored VWAP.|
...
|compounding overflow|POSSIBLE_EXECUTION_BUG|Compounding status: SAFE.|
...
|crypto proxy caveat|IMPLEMENTED_EXACTLY|Marked as US_equity_native_crypto_proxy.|

## Recomputed Metric Snapshot
- trade_count: 326
- PF: 1.528889
- OOS rows: 3
- fee monotonic PF: 1.528889 >= 1.504029 >= 1.479706 >= 1.432573
