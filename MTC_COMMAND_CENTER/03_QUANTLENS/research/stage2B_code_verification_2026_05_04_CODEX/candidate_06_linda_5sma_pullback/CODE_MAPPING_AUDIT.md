...
|---|---|---|
|relative strength|MISSING|No native RS vs market/sector data; crypto proxy cannot verify the original Linda contract.|
...
|crypto proxy caveat|IMPLEMENTED_EXACTLY|Marked as US_equity_RS_native_crypto_proxy.|

## Recomputed Metric Snapshot
- trade_count: 874
- PF: 1.355673
- OOS rows: 3
- fee monotonic PF: 1.355673 >= 1.310809 >= 1.267055 >= 1.18294
