...
- POSSIBLE_EXECUTION_BUG: same-bar breakout fill - Breakout is filled at calculated trigger inside the same daily bar; gap-through behavior is not modeled.
...
- POSSIBLE_EXECUTION_BUG: compounding overflow - Compounding status: OVERFLOW_RISK_CAPPED.
