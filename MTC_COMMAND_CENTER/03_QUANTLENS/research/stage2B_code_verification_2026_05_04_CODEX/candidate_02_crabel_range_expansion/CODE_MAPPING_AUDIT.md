...
|---|---|---|
|same-bar breakout fill|POSSIBLE_EXECUTION_BUG|Breakout is filled at calculated trigger inside the same daily bar; gap-through behavior is not modeled.|
...
|crypto proxy caveat|IMPLEMENTED_EXACTLY|Marked as range_expansion_crypto_proxy.|

## Recomputed Metric Snapshot
- trade_count: 7822
- PF: 1.772742
- OOS rows: 3
- fee monotonic PF: 1.772742 >= 1.609039 >= 1.462264 >= 1.212805
