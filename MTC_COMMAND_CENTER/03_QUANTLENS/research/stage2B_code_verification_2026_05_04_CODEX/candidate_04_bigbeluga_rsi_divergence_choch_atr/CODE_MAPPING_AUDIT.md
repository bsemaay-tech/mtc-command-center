...
|---|---|---|
|RSI divergence rule|MISSING|Previous Stage-2 code used RSI oversold/overbought recovery plus CHoCH, not true price/RSI divergence.|
...
|crypto proxy caveat|IMPLEMENTED_EXACTLY|Marked as crypto_proxy.|

## Recomputed Metric Snapshot
- trade_count: 739
- PF: 1.72521
- OOS rows: 3
- fee monotonic PF: 1.72521 >= 1.691923 >= 1.659414 >= 1.596696
