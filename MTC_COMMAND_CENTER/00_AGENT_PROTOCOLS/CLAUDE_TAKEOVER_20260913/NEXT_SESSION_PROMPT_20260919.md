...
3. Merge-readiness table per candidate (Opus + Sol + Gemini + Lead reproduction on the same bytes); PR-only serial merges under the standing delegation for P0-30/P0-26/P0-21/P0-31; P0-12 merges wait for the owner word `P012-MERGE ... go`.
