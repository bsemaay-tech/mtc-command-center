...
| WEDQ-2 (early) | P0-12 | exact-Opus T0 of the capture tool `af921d75` | Claude PRO `claude-opus-5` xhigh | `OPUS_QUEUE_20260916/P1CAP/` | `launch.exit` | RUNNING since 15:5x |
