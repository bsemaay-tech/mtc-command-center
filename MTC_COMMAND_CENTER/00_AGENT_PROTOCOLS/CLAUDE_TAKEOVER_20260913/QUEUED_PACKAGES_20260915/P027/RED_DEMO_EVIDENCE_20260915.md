...
> **Erratum (2026-09-16, lane-5 T1 review finding F-08):** the sentence above claiming that no `failure` conclusion existed in the last 200 CI runs before the demo is FALSE — `ci.yml` on `master` has exactly one failure ever, run `32846169952` at `110305c0` (2026-08-25T12:10:43Z). The correction was first recorded in `P027_ACCEPTANCE_PACKET_20260915.md` §5.1; this line points at it so the source file no longer stands alone.
