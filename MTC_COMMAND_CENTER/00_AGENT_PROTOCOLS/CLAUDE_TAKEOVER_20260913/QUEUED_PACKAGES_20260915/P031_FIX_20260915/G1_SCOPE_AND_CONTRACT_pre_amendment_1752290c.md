...
1. `LifecycleLedger(path, writer_allowlist, active_check_sets=())`
...
2. `append(event: LifecycleEvent, *, check_set_version=None, evaluation_run_hash=None, failing_checks=(), source_kind="FIXTURE")`
