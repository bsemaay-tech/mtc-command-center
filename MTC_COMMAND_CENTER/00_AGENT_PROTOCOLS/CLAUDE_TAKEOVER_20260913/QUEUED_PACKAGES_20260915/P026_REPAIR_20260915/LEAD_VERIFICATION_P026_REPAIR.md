...
| **`check_p030_closed_partition_backup_adapter.py`** | **exit 1 — 13 tests refuse with `run_not_complete`** (`check_p030_closed_partition_backup_adapter.txt`); the same check exits 0 on the base (`…_BASE_ct13.txt`) |
