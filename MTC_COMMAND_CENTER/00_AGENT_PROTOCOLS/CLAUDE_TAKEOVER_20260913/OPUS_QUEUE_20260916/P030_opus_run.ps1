# Exact claude-opus-5 xhigh T0 review of WP-P0-30 candidate 153edee9 (daf6a43b + O9FIX) on the Claude PRO profile (~/.claude), NOT the Max desktop session.
...
if ($head -ne '153edee97c008b36548cfb0c5bfaf5d7615a91d1') { "HEAD $head != 153edee9: refuse" | Out-File "$lane\launch.exit" -Encoding ascii; exit 3 }
$start = Get-Date
