# Exact claude-opus-5 xhigh T0 review of WP-P0-30 candidate 45a7f50e (= 153edee9 + format-only 53b43c21 + T0 repair round 1 0be0a8aa + parity tweak 45a7f50e) on the Claude PRO profile (~/.claude), NOT the Max desktop session.
...
if ($head -ne 'd426e79f4c7813c6cdf40b6a1049ced6a58a5de5') { "HEAD $head != d426e79f: refuse" | Out-File "$lane\launch.exit" -Encoding ascii; exit 3 }
$start = Get-Date
