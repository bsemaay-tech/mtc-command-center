...
5. **Backlog** — UI-30 producer_spec field-fill (needs approval), Gate3 builder (no scorer; binding decisions in memory mcc-gate3-promotion-decisions), W1 parity-in-night-flow, W2 auto-backtest-selector. Dead `renderDecisionPanel()` cleanup closed 2026-06-08 by Codex GPT-5. Stray hung python PID cleanup checked 2026-06-08 by Codex GPT-5: PIDs 18480/57724/21200 were already absent, no kill needed.
