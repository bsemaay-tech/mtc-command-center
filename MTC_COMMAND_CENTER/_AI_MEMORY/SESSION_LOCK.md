...
| Shared memory layer | `_AI_MEMORY/` handoffs, rules, routing | **UNCLAIMED** — Map #96 fold records released after Lead verification at `d20ed55f`; no runtime, host, credential or economic action | — |
