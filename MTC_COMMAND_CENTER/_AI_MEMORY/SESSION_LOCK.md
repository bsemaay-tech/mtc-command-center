...
| P0-20 definition artifacts (control-parity checklist v1, statistical battery v1) | `DECISIONS.md`; `MTC_COMMAND_CENTER/00_AGENT_PROTOCOLS/HANDOFF.md`; `MTC_COMMAND_CENTER/_AI_MEMORY/SESSION_LOCK.md`; `MTC_COMMAND_CENTER/11_TRIAGE/{INDEX.md,WP_P0_20_ALLOCATOR_STAGES_2026-09-07/LANE_REPORT.md}`; root `{control_parity_checklist.py,check_control_parity_checklist.py,statistical_battery.py,check_statistical_battery.py,unsimulated_controls.py,check_unsimulated_controls.py}` | **CLAIMED — Claude Lead, remote Linux container**; no worktree; branch `claude/oauth-token-expired-bocby8`; overnight run under OD-20260907-1/-2; no protected scope, no acceptance claimed; no tracked-file live dependency | 2026-09-08 |
