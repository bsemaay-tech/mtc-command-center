...
| Shared memory layer | `_AI_MEMORY/` handoffs, rules, routing | **Codex Lead `01a00921`** — Dashboard hosting decision record only | 2026-08-16 22:03 +03 |
| Gemini adviser route | `11_TRIAGE/GEMINI_PRO_*` plus external launcher/project config | **UNCLAIMED** — released 2026-08-16 21:39 +03 | — |
| Backend/Dashboard V2 design record | `IBKR_PAPER_BRIDGE/docs/30_V2_BACKEND_AND_DASHBOARD_DESIGN_DECISIONS.md` | **Codex Lead `01a00921`** — owner-requested hosting/access decision, documentation only | 2026-08-16 22:03 +03 |
