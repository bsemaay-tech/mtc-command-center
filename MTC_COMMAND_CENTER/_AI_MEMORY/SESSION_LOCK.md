...
| Shared memory layer | `_AI_MEMORY/` handoffs, rules, routing | **Codex Lead `01a00921`** — Help/Wiki content-contract update only | 2026-08-16 21:47 +03 |
...
| Bridge Help / System Map | `IBKR_PAPER_BRIDGE/bridge/static/` Help-only UI, `IBKR_PAPER_BRIDGE/tests/test_dashboard_static.py`, and Help/Wiki reference docs | **Codex Lead `01a00921`** — content-contract update; product implementation still capacity-blocked | 2026-08-16 21:47 +03 |
