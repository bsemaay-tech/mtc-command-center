...
## 2026-07-26 Codex GPT-5 KVM2 Phase 0–3 readiness active set

- `.gitattributes`
- `IBKR_PAPER_BRIDGE\tests\test_wal_state_bundle.py`
...
- `MTC_COMMAND_CENTER\11_TRIAGE\KVM2_PROGRAM\audits\READINESS_STATUS.md`
- `MTC_COMMAND_CENTER\11_TRIAGE\KVM2_PROGRAM\rehearsals\summaries\P2_09_REPRODUCIBILITY.md`
- `MTC_COMMAND_CENTER\11_TRIAGE\KVM2_PROGRAM\rehearsals\summaries\P3_03_UBUNTU_STAGING.md`
- `MTC_COMMAND_CENTER\_AI_MEMORY\GLOBAL_HANDOFF.md`
- `MTC_COMMAND_CENTER\_AI_MEMORY\NEXT_STEPS.md`
- `MTC_COMMAND_CENTER\_AI_MEMORY\ACTIVE_FILES.md`
- Local-only exact-base probe: `C:\KVM2F61_PROBE`, `C:\KVM2F61_PAYLOAD`
- Local-only Hyper-V staging preparation: `C:\HyperV\KVM2-Staging`
