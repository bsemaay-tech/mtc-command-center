...
> **POST-REPORT UPDATE (2026-07-13):** Bridge correction `f209acd2` replaced the SMA-8 trail
> calculation described in the historical caveat below with the QuantLens EMA-8 convention.
> The 858/858 golden remains entry-signal parity evidence only; broader exit-execution parity is
> still not claimed.
